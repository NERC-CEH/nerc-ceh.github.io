...
- Those of you who don't yet have that repository locally must clone it from GitHub.  Follow the instructions from [Exercise 2 Step 3](https://nerc-ceh.github.io/version_control/exercise2#step-3--download-clone-the-github-repository) and use the URL of the repository you have chosen to work with.
